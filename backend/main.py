...
app.include_router(job_completion.router, prefix="/api")
app.include_router(reviews.router, prefix="/api")
app.include_router(analytics.router, prefix="/api")
app.include_router(admin.router, prefix="/api")
app.include_router(advertisements.router, prefix="/api")
app.include_router(skills_matching.router, prefix="/api")
app.include_router(job_recommendations.router, prefix="/api")
